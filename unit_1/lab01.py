...
while True:
    ...
    if user == computer:     ####################################### users not defined. changed to user
        print("Looks like a tie") ######################################## bracket was not closed
    ...
    # check all cases if user is rock
        ...
        # check losing case
            ...
            print("Sorry, You lose.") ########################### NO outcome define if user chooses rock and computer picks paper

    # check all cases if user is paper
    elif user == "paper":

        # check winning case
        if computer == "rock": ##################################### Add a column
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") ################################# 'P'rint is not defined. Change to lower case p
